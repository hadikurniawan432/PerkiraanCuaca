...
export default class Weather extends React.Component {
  ...
  getWeather= () =>{
  let url = 'http://api.openweathermap.org/data/2.5/weather?q='+this.state.city+ '&appid=6d4fcbe56338a1c4279fa441801c1cbc&units=metric';
  fetch (url)
  ...
  render() {
    ...
    <View style={styles.containerMain}>
      ...
      <View style={styles.boxHeader}>
          <Text style={{ textAlign: 'center', padding: 30, fontSize: 25, color: '#E8F5E9'}} >Perkiraan Cuaca</Text>
      </View>
      ...
      <View style={styles.boxFotter}>
          <Text style={{ textAlign: 'center', padding: 18, fontSize: 14}} >Copy Right HADIKURNIAWAN@App</Text>
      </View>
